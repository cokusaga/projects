from tkinter import Tk, Label, StringVar, Frame, Button
...
label = Label(window, textvariable=equation_label, font=('consolas', 20), bg="white", width=22, height=2)
label.pack()
...
multiply = Button(frame, text='x', height=4, width=6, font=35, command=lambda: button_press('*'))
...
bracket1 = Button(frame, text='(', height=4, width=6, font=35, command=lambda: button_press('('))
bracket1.grid(row=4, column=0)

bracket2 = Button(frame, text=')', height=4, width=6, font=35, command=lambda: button_press(')'))
bracket2.grid(row=4, column=1)

power = Button(frame, text='^', height=4, width=6, font=35, command=lambda: button_press('**'))
power.grid(row=4, column=2)

clear = Button(frame, text='clear', height=4, width=6, font=35, command=clear)
